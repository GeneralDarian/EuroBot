...
from tools import normal_map_generator as nmg


def euro_designer(img_url: str, sigma: float, intensity: float, nmd: float):
    mapfile = "normal_map_temp.png"
    front_image = "data/coinparts/front.png"
    left_image = "data/coinparts/left.png"
    up_image = "data/coinparts/up.png"
    right_image = "data/coinparts/right.png"
    down_image = "data/coinparts/down.png"
    ...
    # input_file =
    output_file = "data//outputs//output.png"

    response = requests.get(img_url, stream=True)
    img_array = np.asarray(Image.open(response.raw))
    imageio.imwrite("data//inputs//input.png", img_array)
    im = imageio.imread("data//inputs//input.png")
    os.remove("data//inputs//input.png")
